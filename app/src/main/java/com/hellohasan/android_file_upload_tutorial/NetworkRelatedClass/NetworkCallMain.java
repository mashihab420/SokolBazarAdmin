...
public class NetworkCallMain {

    public static void fileUpload(String filePath, ModelAddProduct modelAddProduct) {
        ...
        Gson gson = new Gson();
        String patientData = gson.toJson(modelAddProduct);
